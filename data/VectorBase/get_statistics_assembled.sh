...
python ../../scripts/VectorBase_utils.py stats genes_20230311.txt X 'Anopheles_gambiae_PEST Anopheles_atroparvus_EBRO Anopheles_funestus_FUMOZ Anopheles_albimanus_STECLA' 3 3 >> statistics_assembled.txt
python ../../scripts/VectorBase_utils.py stats genes_20230311.txt X 'Anopheles_gambiae_PEST Anopheles_atroparvus_EBRO Anopheles_funestus_FUMOZ Anopheles_albimanus_STECLA' 2 4 >> statistics_assembled.txt
python ../../scripts/VectorBase_utils.py stats genes_20230311.txt X 'Anopheles_gambiae_PEST Anopheles_atroparvus_EBRO Anopheles_funestus_FUMOZ Anopheles_albimanus_STECLA' 3 4 >> statistics_assembled.txt
python ../../scripts/VectorBase_utils.py stats genes_20230311.txt X 'Anopheles_gambiae_PEST Anopheles_atroparvus_EBRO Anopheles_funestus_FUMOZ Anopheles_albimanus_STECLA' 4 4 >> statistics_assembled.txt
