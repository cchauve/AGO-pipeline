...
$SPP_DCJ_BIN/count2adjacencies.py $RAW_DATA_DIR/species_tree_4.newick $COUNT_DATA_DIR/X_2_AsymmetricWagner.family.csv $RAW_DATA_DIR/families_X_2.txt $RAW_DATA_DIR/gene_orders_X_2.rel.txt > adjacencies.txt 2> adjacencies.log
...
$SPP_DCJ_BIN/spp_dcj.py -c X_2_AsymmetricWagner.family.clean.csv -t species_tree_4.tsv adjacencies.txt -m X_2_AsymmetricWagner.family.adjacencies.idmap > X_2_AsymmetricWagner.family.adjacencies.ilp 2> X_2_AsymmetricWagner.family.adjacencies.sppdcj.log

echo "run gurobi (X_2_AsymmetricWagner.family.adjacencies.sol)"
#gurobi_cl Threadss=$THREADS ResultFile=X_2_AsymmetricWagner.family.adjacencies.sol LogFile=X_2_AsymmetricWagner.family.adjacencies.log X_2_AsymmetricWagner.family.adjacencies.ilp
